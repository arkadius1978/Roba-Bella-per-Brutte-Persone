      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <a href="#catalogo" className="text-slate-600 hover:text-pink-500 font-cartoony font-semibold transition hover:scale-105 transform">
              Il Branco
            </a>
            <a href="#autore" className="text-slate-600 hover:text-pink-500 font-cartoony font-semibold transition hover:scale-105 transform">
              Chi Siamo
            </a>
            <div className="h-6 w-0.5 bg-pink-100 rounded-full"></div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-b-4 border-pink-100 shadow-lg absolute w-full rounded-b-3xl">
          <div className="px-4 pt-4 pb-6 space-y-4">
            ...
            <a href="#catalogo" onClick={() => setIsMobileMenuOpen(false)} className="block px-4 py-2 rounded-xl hover:bg-pink-50 font-cartoony text-xl text-slate-700 font-bold">
              Il Branco
            </a>
