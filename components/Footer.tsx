        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-medium">
              <li><a href="#" className="hover:text-white hover:underline transition decoration-pink-500 decoration-2">Il Libro</a></li>
              <li><a href="#" className="hover:text-white hover:underline transition decoration-pink-500 decoration-2">Chi Siamo</a></li>
              <li><a href="#" className="hover:text-white hover:underline transition decoration-pink-500 decoration-2">Contatti</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="p-3 bg-slate-800 rounded-2xl hover:bg-pink-500 hover:text-white transition duration-300 transform hover:-translate-y-1">
                <Instagram size={20} />
              </a>
              <a href="#" className="p-3 bg-slate-800 rounded-2xl hover:bg-pink-500 hover:text-white transition duration-300 transform hover:-translate-y-1">
                <Facebook size={20} />
